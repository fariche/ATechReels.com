    ...
    $.fn.countdown = function (settings, option) {
        return this.each(function () {
            ...
            setInterval(function () {
                ...
                $element.find("#canvas-days").animateLayer('timer', { end: (days_left * 0.981) }, 500, 'easeOutBounce');
                $element.find("#canvas-hours").animateLayer('timer', { end: (hours_left * 15) }, 500, 'easeOutBounce');
                $element.find("#canvas-minutes").animateLayer('timer', { end: (minutes_left * 6) }, 500, 'easeOutBounce');
                $element.find("#canvas-seconds").animateLayer('timer', { end: (seconds_left * 6) }, 500, 'easeOutBounce');

                $element.find("#days").html(days_left);
                $element.find("#hours").html(hours_left);
                $element.find("#minutes").html(minutes_left);
                $element.find("#seconds").html(seconds_left);
...
// global scope JavaScript method
