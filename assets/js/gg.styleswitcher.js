(function ($) {
    ...
    <div class="clearfix"></div>\
            ...
            var option = 'fixedbg';
            if (location.href.indexOf('index-4.html') > 0) {
                option = 'fixedbg';
            }
            else if (location.href.indexOf('index-5.html') > 0) {
                option = 'slider';
            }
            else if (location.href.indexOf('index-6.html') > 0) {
                option = 'video';
            }
